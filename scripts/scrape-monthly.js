...
async function main() {
  ...
  const CONCURRENT_QUERIES = 15; // Process 5 queries at the same time
  const BATCH_SIZE = 150; // Process 50 queries, then save batch
  ...
  const CONCURRENT_SCRAPES = 9; // Process 9 products concurrently (3x increase - price fetching is heavier)
  const SCRAPE_BATCH_SIZE = 300; // 3x increase
